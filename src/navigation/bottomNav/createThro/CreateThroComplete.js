...
export default CreateThroComplete = () =>{
  ...
  return(<ScrollView>
      ...
      <Text style={{marginTop:10,alignSelf:'center',color:grey,fontFamily:'Nunito-Regular',fontSize:15,textAlign:'center',marginHorizontal:30}}> 
      ...
      <FilledButton
         ...
         lable={'Continue'}
         onPress={()=>{navigation.navigate('WhatAThro')}}/>
  </ScrollView>)
}